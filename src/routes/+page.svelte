				...
				>
					...
					<div class="justify-center w-full mt-5 h-50">
						...
						<input
							...
							name="username"
							required
							class="border border-primary focus:ring-primary rounded-md w-full focus:border-primary focus:ring-opacity-20 border-opacity-20 hover:border-opacity-40 mb-6 mt-2"
						/>
						<!-- svelte-ignore a11y-label-has-associated-control -->
						...
						<input
							...
							name="password"
							required
							class=" border border-primary focus:ring-primary rounded-md w-full focus:border-primary focus:ring-opacity-20 border-opacity-20 hover:border-opacity-40 mt-2 mb-2"
						/>
						<!-- svelte-ignore a11y-label-has-associated-control -->
						<label class="">
						...
						<button
							type="submit"
							class=" w-40 ml-20 lg:ml-52 md:ml-52 sm:ml-52  h-10 mb-8 font-semibold tracking-wide rounded-lg bg-primary text-base-100 mt-6"
						>
							Login
						</button>
					</div>
