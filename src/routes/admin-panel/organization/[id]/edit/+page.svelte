...
<main class="h-screen mb-60">
	...
	>
		<ul>
			...
			<li><a href="/users/assets" class="text-[#7165E3]">Organization</a></li>
			<li>
				<a href="/users/assets/action-plan/create" class="text-[#7165E3]">Edit Organization</a>
			</li>
		</ul>
	</div>
