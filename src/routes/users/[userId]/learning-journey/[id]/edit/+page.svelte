...
<main class="h-screen mb-10">
	...
	>
		<ul>
			...
			<li><a href="/users/assets" class="text-[#7165E3]">Learning Journey</a></li>
			<li>
				<a href="/users/assets/action-plan/create" class="text-[#7165E3]">Edit Learning Journey</a>
			</li>
		</ul>
	</div>
