<script lang="ts">
	...
	const editRoute = `/users/${userId}/assets/appointments/${appointmentId}/edit`;
	const viewRoute = `/users/${userId}/assets/appointments/${appointmentId}/view`;
	const appointmentRoute = `/users/${userId}/assets/appointments/create`;
