...
import { z } from 'zod';
import { createWebNewsfeed } from '$routes/api/services/careplan/assets/web-newsfeed';
...
export const actions = {
	createWebNewsfeedAction: async (event: RequestEvent) => {
		...
		type WebNewsfeedSchema = z.infer<typeof createWebLinkSchema>;
		...
		throw redirect(
			...
			successMessage(`Web newsfeed created successfully!`),
			event
		);
	}
};
