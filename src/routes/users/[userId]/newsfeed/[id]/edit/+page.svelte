...
<main class="h-screen mb-10">
	...
	>
		<ul>
			...
			<li><a href="/users/assets" class="text-[#7165E3]">Newsfeed</a></li>
			<li><a href="/users/assets/action-plan/create" class="text-[#7165E3]">Edit Newsfeed</a></li>
		</ul>
	</div>
	<div class=" flex justify-center mt-5 px-3 mb-10 flex-col items-center">
		<form
			method="post"
			action="?/updateNewsfeed"
			class="w-full lg:max-w-4xl md:max-w-xl sm:max-w-lg bg-[#ECE4FC] rounded-lg mx-auto"
		>
			<div class="w-full  h-14 rounded-t-lg p-3  bg-[#7165E3]">
				<div class="ml-3 relative flex flex-row text-white text-xl">
					Edit Newsfeed
					<a href="/newsfeed/[id]/view">
