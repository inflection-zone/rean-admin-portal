...
<main class="h-screen mb-10">
	...
	>
		<ul>
			...
			<li><a href="/" class="text-[#7165E3]">Newsfeed</a></li>
			<li><a href="./create" class="text-[#7165E3]">Create Items In Newsfeed</a></li>
		</ul>
	</div>
	<div class="px-5 mb-5 ">
		<form
		...
		>
			...
			<div class="flex items-center my-4 lg:mx-16 md:mx-12 mx-10">
				...
				<div class="w-1/2 md:w-2/3 lg:w-2/3">
					<select class="select select-info w-full" placeholder="Select type here...">
