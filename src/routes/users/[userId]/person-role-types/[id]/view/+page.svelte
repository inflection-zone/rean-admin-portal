		...
		>
			<div class="w-full  h-14 rounded-t-lg p-3  bg-[#7165E3]">
				<div class="ml-3 relative flex flex-row text-white lg:text-xl text-lg ">
					<div class="lg:hidden md:hidden block">View Person Role Type</div>
					<div class="lg:block md:block hidden">View Person Role Type</div>
			...
			<div class="flex items-center mb-4 mt-10 lg:mx-16 md:mx-12 mx-10">
				...
				<span class="span w-1/2 md:2/3 lg:2/3" id="roleName">{roleName}</span>
			</div>
