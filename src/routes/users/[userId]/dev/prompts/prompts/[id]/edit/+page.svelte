<script lang="ts">
    ...
    let createdByUserId = prompts.CreatedByUserId;
    ...
    const createRoute = `/users/${userId}/dev/prompts/prompts/create`;
    const promptRoutes = `/users/${userId}/dev/prompts/prompts`;

    const breadCrumbs = [
        { name: 'Prompts', path: promptRoutes },
