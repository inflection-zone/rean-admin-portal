...
import { getModuleById, updateModule } from '../../../../../api/services/admin-panel/module';
...
export const actions = {
  updateModule: async (event: RequestEvent) => {
    ...
    throw redirect(
      303,
      `/admin-panel/learning-journey/module${id}/view`,
