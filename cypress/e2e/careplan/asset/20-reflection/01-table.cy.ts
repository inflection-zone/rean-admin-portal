...
describe('test', () => {
    ...
    cy.wait(3000)
      ...
      cy.wait(2000)
      cy.get('select[class=select]').select('Reflection')
      cy.wait(2000)
      cy.get(':nth-child(2) > :nth-child(6) > .btn > .text-lg').click()
      cy.wait(2000)
      cy.get('input[name=name]').clear()
      cy.wait(2000)
      cy.get('input[name=name]').type('Progress of last 1 year')
      cy.wait(2000)
      cy.get('textarea[name=description]').clear()
      cy.wait(2000)
      cy.get('textarea[name=description]').type('Progress details')
      cy.wait(2000)
      ...
      cy.wait(2000)
      cy.get('input[name=code]').type('Reflection-4')
      cy.wait(5000)
      cy.get('input[name=code]').clear()
      cy.wait(2000)
      cy.get('input[name=name]').type('Progress in the last week')
      cy.wait(5000)
      cy.get('input[name=name]').clear()
    })
	});
