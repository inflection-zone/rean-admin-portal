...
describe('test', () => {
    ...
    cy.wait(3000)
      ...
      cy.wait(2000)
      cy.get('input[name=name]').type('Daily message')
      cy.wait(2000)
      cy.get('textarea[name=description]').clear()
      cy.wait(2000)
      cy.get('textarea[name=description]').type('Do message')
      cy.wait(2000)
      cy.get('select[name=messageType]').select('Status')
      cy.wait(2000)
      ...
      cy.wait(2000)
      cy.get('input[name=code]').type('Message-3')
      cy.wait(5000)
