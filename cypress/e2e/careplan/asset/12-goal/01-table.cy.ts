...
describe('test', () => {
    ...
    cy.wait(3000)
      ...
      cy.wait(2000)
      cy.get('select[class=select]').select('Goal')
      cy.wait(2000)
      cy.get(':nth-child(2) > :nth-child(6) > .btn > .text-lg').click()
      cy.wait(2000)
      cy.get('input[name=name]').clear()
      cy.wait(2000)
      cy.get('input[name=name]').type('New goals')
      cy.wait(2000)
      cy.get('textarea[name=description]').clear()
      cy.wait(2000)
      cy.get('textarea[name=description]').type('Starting new goals')
      cy.wait(2000)
      ...
      cy.wait(2000)
      cy.get('input[name=code]').type('Goal-10')
      cy.wait(5000)
      cy.get('input[name=code]').clear()
      cy.wait(2000)
      cy.get('input[name=name]').type('Reduce Fasting Blood Glucose')
      cy.wait(5000)
      cy.get('input[name=name]').clear()
    })
	});
