...
describe('test', () => {
    ...
    cy.wait(3000)
      ...
      cy.wait(2000)
      cy.get('select[class=select]').select('Assessment')
      cy.wait(2000)
      ...
      cy.wait(2000)
      cy.get('textarea[name=description]').type('Study alone.')
      cy.wait(2000)
      cy.get('textarea[name=template]').clear()
      cy.wait(2000)
      cy.get('textarea[name=template]').type('assesstemp')
      cy.wait(2000)
      ...
      cy.wait(2000)
      cy.get('input[name=code]').type('Assessment-4')
      cy.wait(5000)
