...
describe('test', () => {
    ...
    cy.wait(3000)
      ...
      cy.wait(2000)
      cy.get('select[class=select]').select('Audio')
      cy.wait(2000)
      ...
      cy.wait(2000)
      cy.get('textarea[name=transcript]').clear()
      cy.wait(2000)
      cy.get('textarea[name=transcript]').type('confirm that working')
      cy.wait(2000)
      ...
      cy.wait(2000)
      cy.get('input[name=code]').type('Audio-2')
      cy.wait(5000)
