...
describe('test', () => {
    ...
    cy.wait(3000)
      ...
      cy.wait(2000)
      cy.get('select[class=select]').select('Consultation')
      cy.wait(2000)
      ...
      cy.wait(2000)
      cy.get('select[name=consultationType]').select('Visit-consultation')
      cy.wait(2000)
      ...
      cy.wait(2000)
      cy.get('input[name=code]').type('Consultation-12')
      cy.wait(5000)
