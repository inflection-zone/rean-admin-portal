...
describe('test', () => {
    ...
    cy.wait(3000)
      ...
      cy.wait(2000)
      cy.get('input[name=name]').type('Power')
      cy.wait(2000)
      cy.get('textarea[name=description]').clear()
      cy.wait(2000)
      cy.get('textarea[name=description]').type('Word power details')
      cy.wait(2000)
      cy.get('input[name=additionalResources]').clear()
      cy.wait(2000)
      cy.get('input[name=additionalResources]').type('Add aditional resources')
      cy.wait(2000)
      ...
      cy.wait(2000)
      cy.get('input[name=code]').type('WordPower-9')
      cy.wait(5000)
