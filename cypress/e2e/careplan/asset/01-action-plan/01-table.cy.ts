...
describe('test', () => {
    ...
    cy.wait(3000)
      ...
      cy.wait(2000)
      cy.get('select[class=select]').select('Action plan')
      cy.wait(2000)
      cy.get(':nth-child(2) > :nth-child(6) > .btn > .text-lg').click()
      cy.wait(2000)
      cy.get('input[name=name]').clear()
      cy.wait(2000)
      cy.get('input[name=name]').type('Join')
      cy.wait(2000)
      cy.get('textarea[name=description]').clear()
      cy.wait(2000)
      cy.get('textarea[name=description]').type('Studies')
      cy.wait(2000)
      ...
      cy.wait(2000)
      cy.get('input[name=code]').type('ActionPlan-4')
      cy.wait(5000)
      cy.get('input[name=code]').clear()
      cy.wait(2000)
      cy.get('input[name=name]').type('Join the gym')
      cy.wait(5000)
      cy.get('input[name=name]').clear()
    })
	});
