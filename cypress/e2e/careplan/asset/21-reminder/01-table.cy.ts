...
describe('test', () => {
    ...
    cy.wait(3000)
      ...
      cy.wait(2000)
      cy.get('select[class=select]').select('Reminder')
      cy.wait(2000)
      cy.get(':nth-child(2) > :nth-child(6) > .btn > .text-lg').click()
      cy.wait(2000)
      cy.get('input[name=name]').clear()
      cy.wait(2000)
      cy.get('input[name=name]').type('Do exercise')
      cy.wait(2000)
      ...
      cy.wait(2000)
      cy.get('input[name=code]').type('Reminder-7')
      cy.wait(5000)
      cy.get('input[name=code]').clear()
      cy.wait(2000)
      cy.get('input[name=name]').type('Take a walk')
      cy.wait(5000)
      cy.get('input[name=name]').clear()
    })
	});
